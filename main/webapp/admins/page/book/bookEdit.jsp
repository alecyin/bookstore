        ...
        <div class="layui-row layui-col-space10">
            <div class="layui-col-md9 layui-col-xs7">
                ...
                <div class="layui-form-item magt3">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" id="name" lay-verify="name" placeholder="请输入类别名称">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <a class="layui-btn layui-btn-sm" lay-filter="editCategories" lay-submit>保存</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        form.on("submit(editCategories)", function (data) {
            //弹出loading
